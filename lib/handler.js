...
module.exports.SendInvoice = function(event, context, callback) {
    ...
    var req = event.body;
    send_invoice(req,callback,res,'This email details items that you bid on at the SVUUS auction. Please let us know if there are any problems with this invoice. Your credit card will be charged for $',"SVUUS Auction Invoice", false);
};
...
module.exports.ChargeCustomer = function(event, context, callback) {
	...
	var deferred = new Promise(function(resolve, reject) {
		...
		var purchase_ticket = function(bidnum) {
                    ...
                    guest.stripe_customer_id = guest.customerIid;
	...
	console.log(customer);
		...
		var purch = function(num) {
		    ...
		    var p = add_ticket(ticket, (num == tickets.length - 0));
		    p.then(function(data) {
